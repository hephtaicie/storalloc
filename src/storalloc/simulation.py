...
class Simulation:
    ...
    def update_disk(self, server_id, node_id, disk_id, allocation):
        ...
        # free some disk space
            ...
            # Not raising so far, because this 'error' can be generated by a simple incorrect rounding on our
            # side.
            self.log.error(
                f"Attempting to allocate/deallocate 0GB on {server_id}:{node_id}:{disk_id}"
            )
